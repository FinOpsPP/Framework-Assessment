...
that doesn't include all of the other cloud based finops tasks.
We would like to document a process for using the assessment for various scopes within an organization, 
and how this ultimately turns into an overall score for the org despite having multiple separate scoped assessments.
